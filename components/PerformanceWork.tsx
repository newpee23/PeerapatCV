    ...
    return (
        <section id="performanceWork">
            ...
            <div className="flex flex-col items-center justify-center lg:px-10 text-white">
                ...
                <div className="flex flex-wrap p-7 items-center justify-center w-full max-w-[1200px] lg:min-h-[875px] bg-white bg-blend-normal bg-opacity-5 rounded-md shadow-lg">
