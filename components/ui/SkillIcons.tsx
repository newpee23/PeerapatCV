    ...
    return (
        <div className="flex py-7 items-start justify-center max-w-[1200px] bg-white bg-blend-normal bg-opacity-5 rounded-md shadow-lg">
            <div className="w-full lg:w-6/12 border-l-solid">
                ...
                <div className="flex justify-center p-8 lg:p-0 xl:justify-start flex-wrap mt-[-20px] lg:px-10 text-center">
            ...
            <div className="w-full lg:w-6/12">
                ...
                <div className="flex justify-center p-8 lg:p-0 xl:justify-start flex-wrap mt-[-20px] lg:px-10">
